...
img1=ImageTk.PhotoImage(Image.open('LodiTechs\pattern2.jpg'))
...
"""
# Logo Frame
logo =  customtkinter.CTkImage(Image.open('LodiTechs\Conversatile_Logo.png').resize((20,20), Image.ANTIALIAS))
li1=customtkinter.CTkLabel(master=frame, image=logo, width=100, height=20, corner_radius=6, compound='')
"""
...
button1=customtkinter.CTkButton(master=frame, width=220, text='Login', corner_radius=6, text_color='Black', fg_color='white', hover_color="#A4A4A4", command=button_function)
